...
public class testClienteDispositivo extends AbstractPersistenceTest implements WithGlobalEntityManager {
    ...
    public void casoDePrueba3() {
    	...
    	CondicionPorMayor mayorA20 = new CondicionPorMayor(reglaTest,20,"Temperatura");
    	...
    	CondicionPorMenor menorA30 = new CondicionPorMenor(reglaRecuperada,15,"Temperatura");
