...
public class CargarDatos extends AbstractPersistenceTest implements WithGlobalEntityManager {
    ...
    public void test3cargarIntervaloADispositivoCreado() {
        ...
        DispositivoInteligente diPersistir = new DispositivoInteligente.DispositivoInteligenteBuilder(nombreDI).consumoEstimadoPorHora((double) 0.412).build();
    ...
    {
        DispositivoInteligente di = DispositivosManager.getInstance().getDispositivoInteligenteDeLaBDPorID(new Long(15));
    ...
    {
        DispositivoInteligente di = DispositivosManager.getInstance().getDispositivoInteligenteDeLaBDPorID(new Long(16));
    ...
    public void test6cargarTransformador() {
        ...
        li2.add(i5);
        li2.add(i6);
        DispositivoInteligente di1 = new DispositivoInteligente.DispositivoInteligenteBuilder("Tester1").consumoEstimadoPorHora((double) 0.700).intervalosDeUso(li).build();
        di1.agregarListaIntervalos(li);
        entityManager().persist(di1);

        DispositivoInteligente di2 = new DispositivoInteligente.DispositivoInteligenteBuilder("Tester2").consumoEstimadoPorHora((double)1.110).intervalosDeUso(li).build();
