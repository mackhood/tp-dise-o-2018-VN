...
public class RepositorioDispositivo {
	...
	public RepositorioDispositivo() {
		DispositivoInteligente aireAcondicionado3500 = new DispositivoInteligente("aireAcondicionado",
				"De 3500 frigorias", false, 1.613, 90, 360);
		DispositivoInteligente aireAcondicionado2200 = new DispositivoInteligente("aireAcondicionado",
				"De 2200 frigorias", true, 1.013, 90, 360);
		...
		DispositivoEstandar televisorLCD40 = new DispositivoEstandar.DispositivoEstandarBuilder("televisor")
				...
				.restriccionMinima((double) 90).restriccionMaxima((double) 360).build();
		DispositivoInteligente televisorLED24 = new DispositivoInteligente("televisor", "LED de 24", true, 0.04, 90,
				360);
		DispositivoInteligente televisorLED32 = new DispositivoInteligente("televisor", "LED de 32", true, 0.055, 90,
				360);
		DispositivoInteligente televisorLED40 = new DispositivoInteligente("televisor", "LED de 40", true, 0.08, 90,
				360);
		...
		DispositivoInteligente lavarropas5kg = new DispositivoInteligente("lavarropas", "Automatico de 5kg", true,
				0.175, 6, 30);
		...
		DispositivoInteligente ventiladorDeTecho = new DispositivoInteligente("ventilador", "De techo", true, 0.06, 120,
				360);

		DispositivoInteligente lamparaHalogena40W = new DispositivoInteligente("lampara", "Halogena de 40W", false,
				0.04, 90, 360);
		DispositivoInteligente lamparaHalogena60W = new DispositivoInteligente("lampara", "Halogena de 60W", false,
				0.06, 90, 360);
		DispositivoInteligente lamparaHalogena100W = new DispositivoInteligente("lampara", "Halogena de 100W", false,
				0.015, 90, 360);
